<?php
/**
 * Product + Reviews schema (legacy feature, unchanged behaviour).
 *
 * On pages flagged with the ACF field `activate_product_schema`, converts the
 * Yoast WebPage piece into a Product and injects reviews pulled from the page's
 * testimonial blocks.
 *
 * @since 1.0 (relocated into includes/ at 2.0.0)
 */
